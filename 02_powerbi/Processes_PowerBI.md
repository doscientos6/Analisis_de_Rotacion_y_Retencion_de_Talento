...
Utilizamos las opciones de "Distribución de las columnas" y "Calidad de las columnas" para verificar que las 35 columnas no tengan errores o valores nulos, además que las filas que tienen que ser valores únicos o solo tienen que haber un número exacto de medidas de esa variable se cumplan, por ejemplo attrition o 
